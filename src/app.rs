    ...
    return App::new("Update Manager")
        ...
        .subcommand(SubCommand::with_name("add")
            ...
            .arg(Arg::with_name("number")
                .short("n")
                .long("number")
                .help("Use a line number to specify what command to remove in place of command_one")
                .takes_value(true)
            )
            .arg(Arg::with_name("command")
                .required(true)
        ...
        //     .about("Replace an existing command within the list of tools to update with another")
        //     .arg(Arg::with_name("number")
        //         .short("n")
        //         .long("number")
        //         .help("Use a line number to specify what command to remove")
        //     )
        //     .arg(Arg::with_name("command_one")
        //         .required(true)
        //         .takes_value(true)
        //         .help("The command to remove from the update checker")
        //     )
        //     .arg(Arg::with_name("command_two")
        //         .required(true)
        //         .takes_value(true)
        //         .help("The command to take the place of the command removed from the update checker")
        //     )
        // )
